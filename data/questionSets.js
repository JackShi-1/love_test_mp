const aronEnglishQuestions = require('./aronEnglishQuestions')

const questionSets = [
  {
    id: 'goodbye-love',
    title: '再见爱人版',
    description: '适合情侣 / 夫妻，重新审视关系，走向和解或告别。',
    scenario: '适合已经有共同经历、想认真聊一聊关系的人。',
    mood: '关系复盘 / 情绪表达 / 重新靠近',
    summary: '更像一场认真而温柔的关系对谈。它会把话题慢慢带回“我们”：共同经历、未说出口的感受、还想被理解的地方。',
    tags: ['伴侣', '关系修复', '深度沟通'],
    questions: [
  ...
  },
  {
    id: 'aron',
    title: '亚瑟·阿伦原版',
    description: '适合陌生人 / 初识者，通过逐层自我暴露建立深度亲密感。',
    scenario: '适合初识、约会早期，或想重新认识彼此的伴侣。',
    mood: '自我袒露 / 逐层靠近 / 建立亲密',
    summary: '更像一本由浅入深的相识手册。它从轻松的问题开始，慢慢走向记忆、家庭、脆弱和真实的愿望。',
    tags: ['初识', '约会', '重新认识'],
    questions: [
...
function getQuestionSet(versionId) {
  return questionSets.find((item) => item.id === versionId) || questionSets[0]
}
